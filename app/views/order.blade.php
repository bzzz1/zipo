...
@section('body')
	<div class="main_content">
		...
		<hr class="main_hr">
		{{ Form::model($element, ['url'=>['/order', $element->code], 'files'=>true, 'method'=>'POST', 'class'=>'item_form']) }}
				<table>
					<tr>
					...
					<tr>
						<td>{{ Form::label('item_code', 'Код: ', ['class'=>'main_label']) }}</td>
						<td>{{ Form::text('item_code', null, ['class'=>'change_input change_input_code', 'ng-model'=>'element.item_code', 'required']) }}</td>
					</tr>
					<tr>
