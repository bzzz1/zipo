...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 06 2015 г., 21:30
...
INSERT INTO `creds` (`admin_id`, `login`, `password`) VALUES
...
INSERT INTO `producers` (`producer_id`, `title`, `import`) VALUES
...
INSERT INTO `subcategories` (`subcategory_id`, `title`, `category`) VALUES
(1, 'Плиты', 'Механическое'),
(2, 'Плиты', 'Тепловое'),
(3, 'Батареи', 'Холодильное'),
(4, 'Испарители', 'Посудомоечное'),
(5, 'Полки', 'Механическое');
