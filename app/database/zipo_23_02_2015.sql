...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 23 2015 г., 12:12
...
INSERT INTO `creds` (`id`, `login`, `password`, `discount`, `remember_token`) VALUES
...
(13, '2931001d3', 'ТЭН БАТАРЕИ ИСП.  Р=500 ВТ ШН-1,4  (Lпров.=1500, 2штыр нак с колп), шт', '', '1333.00', 'РУБ', 'no_photo.png', 0, 0, 3, 1, 1),
...
INSERT INTO `users` (`id`, `name`, `surname`, `company`, `email`, `phone`, `activity`, `password`, `timestamp`, `remember_token`) VALUES
