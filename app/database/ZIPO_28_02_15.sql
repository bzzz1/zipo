...
--
-- Хост: localhost:8889
-- Время создания: Фев 28 2015 г., 19:01
...
(1, 'administrator', '$2y$10$tB.79NMsTyzmYG.jgzQ04uaY.j2p3O2PDPVi1gyYjOdoMZBtWzdEm', '3', 'uQkAdqgyFYZtkvacshHn3z7g2scTEp0Qb6PbmP7JztmvXEw49fKwyyncV9P5');
...
(37, '1111111', 'adasd', 'asdasdasdasd', 1000.00, 'РУБ', 'no_photo.png', 0, 0, 5, 3, 1),
(38, '111', 'dfsa', '', 12.00, 'РУБ', 'no_photo.png', 0, 0, 5, 3, 1),
(40, '11111111111', '11111111111', '111', 111.00, 'РУБ', 'no_photo.png', 1, 1, 5, 3, 1);
...
(1, 'Василий', '', 'Vertex', 'vasiliyvertex@gmail.com', '0998965236', 'Технолог', '$2y$10$YCr9/5vzcqNO6NAQA0LNIOkBYpRpn/A2X052YctmIcWM777XfhTHC', '2015-02-19 09:28:30', '2wltjxRmIvOQ3lx37sXwXIQ9pu9rKQfCvEjyxJNOIFBR12UDRLNo4u4SXuYM'),
(7, 'Bogdan', 'Kuts', 'dfdsfsd', 'kootz@yandex.ru', 'asdsfsdf', 'Технолог', '$2y$10$egOMOcmrHeNj.x5U2PCjd.LBG07lqEJ7nVrI.Bz0iAc8tCh1rW.Ta', '2015-02-27 19:23:14', 'ppoVeVWxggJIwAxz83MWw3J6DSpisGh1pxg24VjRZrFrITTNZ9bIWkiMQhYH'),
(8, 'Bogdan', 'Kuts', 'ds', 'sdasd@dasd.asdsdas', 'dsa', 'Технолог', '$2y$10$jfCfuOgg1Ah2PUbizCKox.w4mXV9QRzg2KlJzcL057xWh8A7dbrhK', '2015-02-28 15:29:32', ''),
(9, 'Bogdan', 'Kuts', 'sdsa', 'BodyaKootz@gmail.com', 'das', 'Технолог', '$2y$10$Len4E8XWxLj9RKh7G9oHzuIlU/FITTNvHWNvI0U1bajR8y6e2Irlq', '2015-02-28 15:47:51', '');
...
--
ALTER TABLE `items`
 ADD PRIMARY KEY (`item_id`), ADD UNIQUE KEY `code` (`code`);
